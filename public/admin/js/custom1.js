...
function get_fees_details(){
	if (document.getElementById('tution_fees') != null) {
		...
		course_prefered = $("#course_prefered").val();
		console.log(course_prefered);
		hostel = $('input[name=bus_hostel]:checked', '#myForm').val();
		console.log(hostel);
		if (quota == "management" && course_prefered != "AGRI" && community == 'SC' && hostel == 'Hostel') {
			console.log("hostal&sc");
			total =15000;
			total1 =(total-fa-sr);
			document.getElementById('total_fees').value = total;	
		}
		else if(quota == "management" && course_prefered != "AGRI" && community == 'SC' && hostel == 'Bus'){
			total = 0;
			total1 =(total-fa-sr);
			document.getElementById('total_fees').value = total;	
		}
		else if (quota == "management" && course_prefered != "AGRI" && community == 'SCA' && hostel == 'Hostel') {
			console.log("hostal&sc");
			total =15000;
			total1 =(total-fa-sr);
			document.getElementById('total_fees').value = total;	
		}
		else if(quota == "management" && course_prefered != "AGRI" && community == 'SCA' && hostel == 'Bus'){
			total = 0;
			total1 =(total-fa-sr);
			document.getElementById('total_fees').value = total;	
		}
		else if (quota == "management" && course_prefered != "AGRI" && community == 'ST' && hostel == 'Hostel') {
			console.log("hostal&sc");
			total =15000;
			total1 =(total-fa-sr);
			document.getElementById('total_fees').value = total;	
		}
		else if(quota == "management" && course_prefered != "AGRI" && community == 'ST' && hostel == 'Bus'){
			total = 0;
			total1 =(total-fa-sr);
			document.getElementById('total_fees').value = total;	
		}
